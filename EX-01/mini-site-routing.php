...
<ul>
      ...
      <li> <a href="http://localhost/ISCC/ISCC-2020-J09/EX-01/connexion.php?page=connexion">Connexion</a></li> 

<?php 
if ($_COOKIE['cookie'])
{
    echo '<li> <a href="http://localhost/ISCC/ISCC-2020-J09/EX-01/mini-site-routing.php?page=admin">Admin</a>';
}  
?>
